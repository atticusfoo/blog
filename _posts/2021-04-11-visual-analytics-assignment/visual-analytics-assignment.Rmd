...
# Overview: Difficult to sense-make news headlines in digital landscape 
...
## 4.**Objective 1: Explore** - Sorting through and identifying key events in large corpus of news
...
## 5.**Objective 2: Discover** -] Providing greater detail and context about a topic / news source using sentiment
...
## 6.**Objective 2: Discover** - Providing greater detail and context about a topic / news source using word networks and co-occurrences 
Word network
...
## 7.**Objective 3: Detect** - Providing alerts to unusual patterns in news analysis 
