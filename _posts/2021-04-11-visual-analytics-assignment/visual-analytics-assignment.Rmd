...
![Visualizing sets with linear diagrams](images/linear.png)
...
![Comparison of different scalings of mosaic and lienar diagrams](images/moasic linear diagram.png)
...
![Doing this will give the distribution for the topic distribution for the first document](images/tidytextlda.png)
